...
Choose ONE style theme that best matches the user's description, brand tone, and campaign context.
...
- If the user mentions a specific color palette, reflect that in the theme_description even if mapping to a general theme.
