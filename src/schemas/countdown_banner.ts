...
export const CountdownBannerTemplateSchema = z.object({
  ...
  act_text: z.string().nullable().optional(),
  btn_style: z.number().int().min(0).max(8).nullable().optional(),
  ...
  enable_coupon: z.boolean().nullable().optional(),
  coupon_code: z.string().nullable().optional(),
  btn_copy: BtnCopySchema.nullable().optional(),
  discount_style: DiscountStyleSchema.nullable().optional(),
});
