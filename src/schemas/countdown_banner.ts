...
export const CountdownBannerTemplateSchema = z.object({
  ...
  content_order: z.string().default("text,countdown,action"),
  content_gap: z.number().min(0).max(200).default(16),
  banner_text: z.string(),
  countdown_format: z.enum(["dd:hh:mm:ss", "hh:mm", "dd:hh:mm", "hh:mm:ss", "mm:ss"]).default("dd:hh:mm:ss"),
  font_size_countdown: z.number().default(13),
  timer_color: z.string().default("{\"background\":\"#494949\",\"text\":\"#ffffff\",\"number\":\"#ffffff\",\"border\":\"#ff3f3f\",\"flipLine\":\"#000\",\"accentColor\":\"#FF3366\"}"),
  digit_style: z.union([z.literal(0), z.literal(1), z.literal(2), z.literal(3)]).default(0),
