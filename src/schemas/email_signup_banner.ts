...
export const FormStructureSchema = z.object({
  contentOrder: z.string().nullable().optional(),
  fieldGap: z.number().nullable().optional(),
  bannerGap: z.number().nullable().optional(),
  inputTextColor: z.string().nullable().optional(),
  inputBGColor: z.string().nullable().optional(),
  inputBorderColor: z.string().nullable().optional(),
  inputBorderRadius: z.string().nullable().optional(),
  inputFontSize: z.number().nullable().optional(),
  inputPadding: z.string().nullable().optional(),
  structures: z.array(FormStructureFieldSchema).nullable().optional(),
});

export const EmailSignupBannerTemplateSchema = z.object({
  template: z.literal(0),
  banner_text: BannerTextSchema,
  bg_type: z.union([z.literal(0), z.literal(1), z.literal(2)]).nullable().optional(),
  bg_color: z.string().nullable().optional(),
  font_size_button: z.number().nullable().optional(),
  ...
  button_styles: ButtonStylesSchema.nullable().optional(),
  btn_settings: BtnSettingsSchema.nullable().optional(),
  content_gap: z.number().nullable().default(16),
  content_order: z.string().nullable().optional(),
  form_structure: FormStructureSchema.nullable().optional(),
});

export const EmailSignupBannerSchema = z.object({
  banner_type: z.literal(1),
  position: z.union([z.literal(0), z.literal(1)]).nullable().optional(),
  name: z.string(),
  close_button: z.boolean(),
  btn_close_color: z.string().nullable().default("#FFFFFF"),
  show_device: z.enum(["all", "mobile", "desktop"]).nullable().optional(),
